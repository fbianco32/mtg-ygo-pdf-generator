import Utils
import PDFService
from gameServices.mtg import MTGCardService, MTGDecksService


try:
    Utils.makeTempDir()
    #Debug
    images = MTGCardService.getCardsFromFile(18)
    PDFService.assemblePDF(images, 73, 98, 5, '#13160d', 63, 88, False, False, 'mtgOutput') # A4

    # images = YGOCardService.getCardsFromFile(2133)
    # PDFService.assemblePDF(images, 210, 297, 5, '#60647f', 59, 86, False, False, 'ygoOutput') # 1 card per page
